...
You will need the node_modules to start, we didnt submit them because the folder size was too big.
To do this type: npm install

Starting:

To start bank-api, go to where the file is located, open cmd and type: node server.js

To start bank-frontend, go to where the file is located, open cmd and type: npm start
